import adminCss from '../css/index.scss'
...
console.log('index模块加载完毕');
{
                ...
                <ul>
                    <li>
                        <a href="./recommend.html">
                            <img src="${require('../assets/album1.jpg')}" alt="">
                            <p>2018 MTV音乐大奖 VMA入围名单</p>
                        </a>
                    </li>
                    <li>
                        <a href="./recommend.html">
                            <img src="${require('../assets/album2.jpg')}" alt="">
                            <p>你有没有很想和谁重新认识一次重新认识一次</p>
                        </a>
                    </li>
                    <li>
                        <a href="./recommend.html">
                            <img src="${require('../assets/album3.jpg')}" alt="">
                            <p>午睡民谣</p>
                        </a>
                    </li>
                    <li>
                        <a href="./recommend.html">
                            <img src="${require('../assets/album4.jpg')}" alt="">
                            <p>毛阿姨唱过的歌</p>
                        </a>
                    </li>
                    <li>
                        <a href="./recommend.html">
                            <img src="${require('../assets/album5.jpg')}" alt="">
                            <p>『港乐』香港音乐大师第三辑：黄霑作品集</p>
                        </a>
                    </li>
                    <li>
                        <a href="./recommend.html">
                            <img src="${require('../assets/album6.jpg')}" alt="">
    ...
    let controller = {
        ...
        loadPlayLists(){
            let playLists = document.createElement('script')
        ...
        loadLatestMusic(){
            let latestMusic = document.createElement('script')
